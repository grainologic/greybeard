...
Review the target (a diff, a file, or files named in the argument; default to the current uncommitted diff) against two rubrics. Read them first: `standards/coding.md` and `standards/writing.md` in this extension's directory.
