...
Scan the whole repository against `../../standards/core.md`, `../../standards/coding.md`, and `../../standards/writing.md`, resolved relative to this SKILL.md file, not the working directory. Unlike greybeard-review, this reads the codebase rather than a diff, so it will miss nothing to a read window but must stay ruthless about ranking.
