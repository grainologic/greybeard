...
7. **Behaviour claims are testable.** If you cannot point at the line or run the command, do not write the claim as fact; unverified claims follow the standing orders.
...
NEVER SACRIFICE: clarity, accuracy, or completeness of meaning to save words. Brevity first, but brevity to the point of obfuscation is extra cognitive load for comprehension. Cutting a caveat that changes the decision, or a step the reader needs, is not concision but a defect.
